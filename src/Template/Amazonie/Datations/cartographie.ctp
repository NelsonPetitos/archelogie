...
<input type="hidden" id="mapregion" value="amazonie" />
...
<input type="hidden" id="mapdatasurl" value="<?= Cake\Routing\Router::url(['controller' => 'Datations', 'action' => 'getSessionDatations', 'prefix' => 'amazonie']);?>"/>
<input type="hidden" id="ajaxSliderUrl" value="<?= Cake\Routing\Router::url(['controller' => 'Datations', 'action' => 'cartographie', 'prefix' => 'amazonie']);?>"/>
