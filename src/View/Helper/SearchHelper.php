    ...
    public function displayField($field, $type, $extern=null){
        ...
        if($type == 'number'){
            ...
            return '<div class="input-group">'.
                ...
                '</select>'.
                '</span>'.
                '<input type="text" placeholder="yyyy-mm-dd" data-datatype="'.$type.'" class="form-control" data-tab="'.$table.'" data-exfield="'.$extern.'" data-opname="'.$field.'" data-class="archeologie"/>'.
                '</div>';
        }
